...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionCreate_Batch_File = QAction(MainWindow)
        self.actionCreate_Batch_File.setObjectName(u"actionCreate_Batch_File")
        self.actionOpen_Batch_File = QAction(MainWindow)
        self.actionOpen_Batch_File.setObjectName(u"actionOpen_Batch_File")
        ...
        self.horizontalLayout_file_commands.setContentsMargins(-1, 2, -1, 2)
        ...
        sizePolicy1.setHeightForWidth(self.load_edf_textEdit.sizePolicy().hasHeightForWidth())
        self.load_edf_textEdit.setSizePolicy(sizePolicy1)
        ...
        self.label.setMaximumSize(QSize(60, 10))

        self.horizontalLayout_file_commands.addWidget(self.label)
        ...
        sizePolicy1.setHeightForWidth(self.load_annotation_textEdit.sizePolicy().hasHeightForWidth())
        self.load_annotation_textEdit.setSizePolicy(sizePolicy1)
        ...
        self.horizontalLayout_hypnogram.setContentsMargins(-1, 2, -1, 2)
        ...
        sizePolicy3.setHeightForWidth(self.hypnogram_graphicsView.sizePolicy().hasHeightForWidth())
        self.hypnogram_graphicsView.setSizePolicy(sizePolicy3)
        self.hypnogram_graphicsView.setMinimumSize(QSize(0, 80))
        self.hypnogram_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy4.setHeightForWidth(self.hypnogram_label.sizePolicy().hasHeightForWidth())
        self.hypnogram_label.setSizePolicy(sizePolicy4)
        ...
        self.horizontalLayout_spectrogram_plot.setContentsMargins(-1, 2, -1, 2)
        ...
        sizePolicy3.setHeightForWidth(self.spectrogram_graphicsView.sizePolicy().hasHeightForWidth())
        self.spectrogram_graphicsView.setSizePolicy(sizePolicy3)
        self.spectrogram_graphicsView.setMinimumSize(QSize(0, 75))
        self.spectrogram_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.horizontalLayout_spectrogram_command_2.setContentsMargins(-1, 2, -1, -1)
        ...
        sizePolicy5.setHeightForWidth(self.compute_spectrogram_pushButton.sizePolicy().hasHeightForWidth())
        self.compute_spectrogram_pushButton.setSizePolicy(sizePolicy5)
        ...
        self.horizontalLayout_annotation_plot.setContentsMargins(-1, 2, -1, 2)
        ...
        sizePolicy3.setHeightForWidth(self.graphicsView_annotation.sizePolicy().hasHeightForWidth())
        self.graphicsView_annotation.setSizePolicy(sizePolicy3)
        self.graphicsView_annotation.setMinimumSize(QSize(0, 25))
        self.graphicsView_annotation.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.label_5.setMinimumSize(QSize(40, 20))
        ...
        sizePolicy1.setHeightForWidth(self.epochs_textEdit.sizePolicy().hasHeightForWidth())
        self.epochs_textEdit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy4.setHeightForWidth(self.epochs_label.sizePolicy().hasHeightForWidth())
        self.epochs_label.setSizePolicy(sizePolicy4)
        ...
        self.label_9.setMinimumSize(QSize(30, 20))
        ...
        sizePolicy5.setHeightForWidth(self.previous_pushButton.sizePolicy().hasHeightForWidth())
        self.previous_pushButton.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.last_epoch_pushButton.sizePolicy().hasHeightForWidth())
        self.last_epoch_pushButton.setSizePolicy(sizePolicy5)
        ...
        self.label_7.setMinimumSize(QSize(40, 20))
        ...
        sizePolicy3.setHeightForWidth(self.signal_1_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_1_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_1_graphicsView.setMinimumSize(QSize(0, 50))
        self.signal_1_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_2_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_2_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_2_graphicsView.setMinimumSize(QSize(0, 50))
        self.signal_2_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_3_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_3_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_3_graphicsView.setMinimumSize(QSize(50, 50))
        self.signal_3_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_4_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_4_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_4_graphicsView.setMinimumSize(QSize(50, 50))
        self.signal_4_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_5_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_5_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_5_graphicsView.setMinimumSize(QSize(50, 50))
        self.signal_5_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_6_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_6_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_6_graphicsView.setMinimumSize(QSize(0, 50))
        self.signal_6_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_7_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_7_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_7_graphicsView.setMinimumSize(QSize(50, 50))
        self.signal_7_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_8_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_8_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_8_graphicsView.setMinimumSize(QSize(0, 50))
        self.signal_8_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_10_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_10_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_10_graphicsView.setMinimumSize(QSize(0, 50))
        self.signal_10_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy3.setHeightForWidth(self.signal_9_graphicsView.sizePolicy().hasHeightForWidth())
        self.signal_9_graphicsView.setSizePolicy(sizePolicy3)
        self.signal_9_graphicsView.setMinimumSize(QSize(0, 50))
        self.signal_9_graphicsView.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.graphicsView_x_axis.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.menuFile.addAction(self.actionCreate_Batch_File)
        self.menuFile.addAction(self.actionOpen_Batch_File)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCreate_Batch_File.setText(QCoreApplication.translate("MainWindow", u"Create Batch File", None))
        self.actionOpen_Batch_File.setText(QCoreApplication.translate("MainWindow", u"Open Batch File", None))
