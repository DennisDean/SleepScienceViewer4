...
################################################################################
## Form generated from reading UI file 'CreateBatchFileClass.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy1.setHeightForWidth(self.groupBox_subject_extraction_id.sizePolicy().hasHeightForWidth())
        self.groupBox_subject_extraction_id.setSizePolicy(sizePolicy1)
        ...
        self.radioButton_edf.setEnabled(False)
        self.radioButton_edf.setGeometry(QRect(220, 40, 71, 25))
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.radioButton_edf.sizePolicy().hasHeightForWidth())
        self.radioButton_edf.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.radioButton_generate.sizePolicy().hasHeightForWidth())
        self.radioButton_generate.setSizePolicy(sizePolicy2)
        ...
        self.radioButton_extract.setEnabled(False)
        self.radioButton_extract.setGeometry(QRect(120, 40, 81, 25))
        sizePolicy2.setHeightForWidth(self.radioButton_extract.sizePolicy().hasHeightForWidth())
        self.radioButton_extract.setSizePolicy(sizePolicy2)
        ...
        sizePolicy4.setHeightForWidth(self.plainTextEdit_subject_id_function.sizePolicy().hasHeightForWidth())
        self.plainTextEdit_subject_id_function.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.plainTextEdit_subject_prefix.sizePolicy().hasHeightForWidth())
        self.plainTextEdit_subject_prefix.setSizePolicy(sizePolicy4)
        ...
        self.verticalLayout_select.addWidget(self.label_3)
        ...
        sizePolicy4.setHeightForWidth(self.plainTextEdit_selected_folder.sizePolicy().hasHeightForWidth())
        self.plainTextEdit_selected_folder.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_select_batch_folder.sizePolicy().hasHeightForWidth())
        self.pushButton_select_batch_folder.setSizePolicy(sizePolicy5)
        ...
        self.verticalLayout_message = QVBoxLayout()
        self.verticalLayout_message.setObjectName(u"verticalLayout_message")
        self.line_2 = QFrame(Dialog)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setFrameShape(QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QFrame.Shadow.Sunken)

        self.verticalLayout_message.addWidget(self.line_2)
        ...
        self.verticalLayout_message.addLayout(self.horizontalLayout_5)


        self.verticalLayout.addLayout(self.verticalLayout_message)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_subject_extraction_id.setTitle(QCoreApplication.translate("Dialog", u"Subject ID", None))
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"From EDF FileName", None))
        self.pushButton_select_subject_id_function.setText(QCoreApplication.translate("Dialog", u"...", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"Subject Prefix", None))
        self.label_3.setText(QCoreApplication.translate("Dialog", u"Select Data Folder", None))
